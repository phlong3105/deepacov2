# Docker commands
# sudo docker build -t deepacov2 .
# sudo docker run --name deepacov2 --gpus all -it deepacov2
# sudo docker exec -it deepacov2 bash
# sudo docker commit 061fe080bcdd phlong/deepacov2
# sudo docker login
# sudo docker push phlong/deepacov2
# sudo docker run --name deepacov2 --gpus all -it phlong/deepacov2
