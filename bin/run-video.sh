...
read -e -i "$subset"  -p "Subset [testA, testB]: " subset
...
if [ "$preprocess" == "yes" ]; then
  for video in ${video_list[*]}; do
    ...
    echo -e "\nCleaning up"
    rm -rf "${root_dir}/data/${dataset}/${subset}/convert"
    rm -rf "${root_dir}/data/${dataset}/${subset}/deblur"
    rm -rf "${root_dir}/data/${dataset}/${subset}/person"
    rm -rf "${root_dir}/data/${dataset}/${subset}/tray"
  done
fi
